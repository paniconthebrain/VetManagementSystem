...
public class AppointmentReport extends Application {
	...
	public void start(Stage primaryStage) {
		...
		// Table
		// Create and assign appointment table
		...
		printBtn.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent actionEvent) {
				...
				for (AppointmentModel appointment : appointments) {
					reportData.add(Map.of("ID", String.valueOf(appointment.getAppointmentId()), "Customer",
							appointment.getCustomerName(), "Date", appointment.getAppointmentDate().toString(),
	...
	// Defines columns and layout for the appointment table
	...
	// Loads appointment data from the database into the table
